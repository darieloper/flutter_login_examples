...
class PrimaryLogin extends StatefulWidget {
  PrimaryLogin({Key key}) : super(key: key);

  _PrimaryLogin createState() => _PrimaryLogin();
}

class _PrimaryLogin extends State<PrimaryLogin> {
